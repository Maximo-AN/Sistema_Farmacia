...
public class frmProv extends javax.swing.JFrame {
    ...
    /**
     * Creates new form frmProv
     */
    
    ArrayList<Integer> ids = new ArrayList();
    int xMouse, yMouse, ans;
    ...
    public frmProv() {
        ...
        try{
            ...
            int[] anchos = {5,50,70,200,40};
            for(int i = 0; i<tblProv.getColumnCount(); i++ ){
                tblProv.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
            }
        ...
        tblProv.setEnabled(false);
        
        //Lista por si se modificará la ID de algun producto.
        for(int n = 0; n < tblProv.getRowCount() ; n++){
            int f = 0;
            f = Integer.valueOf(tblProv.getValueAt(n, 0).toString());
            ids.add(f);
            }
    ...
    private void initComponents() {
        ...
        tblProv.setFont(new java.awt.Font("Roboto Black", 0, 12)); // NOI18N
        ...
        tblProv.setOpaque(false);
        scpTabla.setViewportView(tblProv);
        ...
        btnBuscar.setBackground(new java.awt.Color(51, 171, 185));
        ...
        lblBuscar.setBackground(new java.awt.Color(51, 51, 255));
        ...
        btnRefrescar.setBackground(new java.awt.Color(51, 171, 185));
        ...
        cboCategoria.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Patente/Genericos", "Cuidado personal", "Venta libre", "Patente", "Genericos" }));
        ...
        pnlFondo.add(cboCategoria, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 510, -1, -1));
        ...
        pnlFondo.add(lblFiltDeco2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 490, -1, -1));
        ...
        btnBaja.setBackground(new java.awt.Color(27, 58, 78));
        ...
        btnAceptar.setBackground(new java.awt.Color(27, 58, 78));
        ...
        btnEdit.setBackground(new java.awt.Color(27, 58, 78));
        ...
        btnSalir.setBackground(new java.awt.Color(27, 58, 78));
        ...
        btnConfirmar.setBackground(new java.awt.Color(27, 58, 78));
        ...
        btnAlta.setBackground(new java.awt.Color(27, 58, 78));
        ...
        lblAdminMan.setText("ADMINISTRACIÓN");
        ...
        pnlEcs.setBackground(new java.awt.Color(27, 58, 78));
        ...
        pnlMin.setBackground(new java.awt.Color(27, 58, 78));
        ...
        pnlMenu.setBackground(new java.awt.Color(27, 58, 78));
        ...
        pnlProveedor.setBackground(new java.awt.Color(27, 58, 78));
        ...
        lblProveedor.setText("PRODUCTOS");
        ...
        pnlCred.setBackground(new java.awt.Color(27, 58, 78));
        ...
        pnlTicket.setBackground(new java.awt.Color(27, 58, 78));
        ...
        lblFondito.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/if6.jpg"))); // NOI18N
    ...
    private void lblBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBuscarMouseClicked
        ...
        if(res==0){
            ...
            switch (opcion) {
                ...
                opcion = "prov_nom";
                sql = "SELECT *"
                + " FROM proveedores WHERE "+opcion+" = '"+datos+"'";
                break;
                case "Direccion":
                opcion = "prov_dir";
                sql = "SELECT *"
    ...
    private void lblBuscarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBuscarMouseEntered
        btnBuscar.setBackground(new Color(242,99,31));
    ...
    private void lblBuscarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBuscarMouseExited
        btnBuscar.setBackground(new Color(51,171,185));
    ...
    private void lblRefrescarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblRefrescarMouseEntered
        btnRefrescar.setBackground(new Color(242,99,31));
    ...
    private void lblRefrescarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblRefrescarMouseExited
        btnRefrescar.setBackground(new Color(51,171,185));
    ...
    private void lblBajaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBajaMouseClicked
        // Eliminar producto
        JOptionPane.showMessageDialog(null, "Seleccione al proveedor a dar de baja",
    ...
    private void lblBajaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBajaMouseEntered
        btnBaja.setBackground(new Color(242,99,31));
    ...
    private void lblBajaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblBajaMouseExited
        btnBaja.setBackground(new Color(27,58,78));
    ...
    private void lblAceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAceptarMouseClicked
        int res = JOptionPane.showConfirmDialog(null, "¿Esta segur@ de eliminar al proveedor seleccionado?",
            "Pregunta", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE,
            iconito("/images/signo-de-interrogacion.png", 40, 40));
        if(res==0){
            Connection con = null;
            int fila = tblProv.getSelectedRow();
            String valor = tblProv.getValueAt(fila, 0).toString();
            try{
                con = getConnection();
                PreparedStatement borrar = con.prepareStatement("DELETE FROM proveedores "
                    + "WHERE prov_id = '"+valor+"'");
    ...
    private void lblAceptarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAceptarMouseEntered
        btnAceptar.setBackground(new Color(242,99,31));
    ...
    private void lblAceptarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAceptarMouseExited
        btnAceptar.setBackground(new Color(27,58,78));
    ...
    private void lblEditMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEditMouseEntered
        btnEdit.setBackground(new Color(242,99,31));
    ...
    private void lblEditMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEditMouseExited
        btnEdit.setBackground(new Color(27,58,78));
    ...
    private void lblSalirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSalirMouseClicked
        ...
        btnConfirmar.setVisible(false);
        tblProv.setEnabled(false);
        lblFiltDeco2.setFocusable(true);
    ...
    private void lblSalirMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSalirMouseEntered
        btnSalir.setBackground(new Color(242,99,31));
    }//GEN-LAST:event_lblSalirMouseEntered

    private void lblSalirMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSalirMouseExited
        btnSalir.setBackground(new Color(27,58,78));
        ...
        if(ans==1){
            ...
            try{
                ...
                for(int i = 0;i < tblProv.getRowCount(); i++){
                    ps = con.prepareStatement("UPDATE proveedores SET prov_id = ?, "
                        + "prov_nom = ?, prov_mail = ?, prov_dir = ?, prov_cat = ? "
                        + "WHERE prov_id = ?");
                    ps.setInt(1, Integer.valueOf(tblProv.getValueAt(i, 0).toString()));

                    ps.setString(2, tblProv.getValueAt(i, 1).toString());

                    ps.setString(3, tblProv.getValueAt(i, 2).toString());

                    ps.setString(4, tblProv.getValueAt(i, 3).toString());

                    ps.setString(5, tblProv.getValueAt(i, 4).toString());

                    ps.setInt(6, ids.get(i));
                    ps.executeUpdate();
                }
    ...
    private void lblConfirmarMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblConfirmarMouseEntered
        btnConfirmar.setBackground(new Color(242,99,31));
    ...
    private void lblConfirmarMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblConfirmarMouseExited
        btnConfirmar.setBackground(new Color(27,58,78));
    ...
    private void lblAltaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAltaMouseClicked
        ...
        int e;
        do{
            JTextField nombreprov = new JTextField();
            JTextField emailprov = new JTextField();
            JComboBox cateprov = new JComboBox();
            JTextField dirprov = new JTextField();
            cateprov.addItem("Patente/Genericos");
            cateprov.addItem("Cuidado personal");
            cateprov.addItem("Venta Libre");
            cateprov.addItem("Patente");
            cateprov.addItem("Genericos");
            Object[] campos = {
                "Nombre:", nombreprov,
                "Email:", emailprov,
                "Dirección:", dirprov, 
            ...
            int res = JOptionPane.showConfirmDialog(null, campos, "Alta de Proveedor",
                JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE,
                iconito("/images/proveedor.png", 40, 40));
            if(res==0){
                if(nombreprov.getText().equals("") || emailprov.getText().equals("")
                   || dirprov.getText().equals("")){
                JOptionPane.showMessageDialog(null, "No deje ningun campo vacio", "Aviso",
                        JOptionPane.INFORMATION_MESSAGE);
            }
                else{
                String nombre = nombreprov.getText();
                String email = emailprov.getText();
                String cate = cateprov.getSelectedItem().toString();
                String dir = dirprov.getText();
                ...
                int ans = JOptionPane.showOptionDialog(null, "¿Desea agregar a otro proveedor?", "Pregunta",
    ...
    private void lblAltaMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAltaMouseEntered
        btnAlta.setBackground(new Color(242,99,31));
    ...
    private void lblAltaMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblAltaMouseExited
        btnAlta.setBackground(new Color(27,58,78));
    ...
    private void lblEcsMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEcsMouseExited
        pnlEcs.setBackground(new Color(27,58,78));
    ...
    private void lblProveedorMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblProveedorMouseEntered
        pnlProveedor.setBackground(new Color(51,171,185));
    ...
    private void lblProveedorMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblProveedorMouseExited
        pnlProveedor.setBackground(new Color(27,58,78));
    ...
    private void lblCredMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCredMouseEntered
        pnlCred.setBackground(new Color(51,171,185));
    ...
    private void lblCredMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblCredMouseExited
        pnlCred.setBackground(new Color(27,58,78));
    ...
    private void lblTicketMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblTicketMouseEntered
        pnlTicket.setBackground(new Color(51,171,185));
    ...
    private void lblTicketMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblTicketMouseExited
        pnlTicket.setBackground(new Color(27,58,78));
    ...
    private void lblMinMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinMouseExited
        pnlMin.setBackground(new Color(27,58,78));
